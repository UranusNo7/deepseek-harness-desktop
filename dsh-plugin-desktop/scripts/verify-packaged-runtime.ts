...
export const REQUIRED_PACKAGED_RUNTIME_ENTRIES = [
  ...
  'agent-presets/standard-firecrawl/agent.cordis.yml',
  'agent-presets/standard-firecrawl/preset.yml',
  'node_modules/@deepseek-ai/dsh/lib/bin.js',
  'node_modules/@deepseek-ai/dsh-llm-model-policy/lib/index.js',
...
export const REQUIRED_UNPACKED_RUNTIME_ENTRIES = [
  ...
  'node_modules/@deepseek-ai/dsh/lib/bin.js',
  'node_modules/@deepseek-ai/dsh-llm-model-policy/package.json',
  'node_modules/@deepseek-ai/dsh-llm-model-policy/lib/index.js',
...
export const REQUIRED_UNPACKED_PACKAGE_SPECIFIERS = [
  ...
  '@deepseek-ai/dsh-llm-model-policy/package.json',
