window.__ModuleLoader__.load({
	id: "@deepseek-ai/dsh-codex-model-policy",
	factory: (require) => {
		var module = { exports: {} };
		...
		*/
		...
		var ModelDirectoryResolver = class extends _deepseek_ai_cordis.Service {
			...
			*/
			directoryFor(sessionId) {
				...
				if (actx === void 0) throw new Error(`codex-model-policy: session "${String(sessionId)}" resolved no scope`);
		...
		//#endregion
		//#region \0dsh-css:D:\python_code\deepseek-harness-master\packages\llm\codex-model-policy\src\client\ModelSelect.module.css.mjs
		const css = ".sv0ekq_root{min-width:0;position:relative}.sv0ekq_trigger{min-width:0;max-width:220px;height:28px;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:none;border-radius:24px;outline:none;align-items:center;gap:4px;padding:0 4px 0 8px;font-size:13px;font-weight:500;line-height:20px;display:flex}.sv0ekq_trigger:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover)}.sv0ekq_trigger:focus-visible{box-shadow:0 0 0 2px var(--dsw-alias-border-l3)}.sv0ekq_trigger:disabled{color:var(--dsw-alias-label-dimmed);cursor:default}.sv0ekq_triggerLabel{text-overflow:ellipsis;white-space:nowrap;min-width:0;overflow:hidden}.sv0ekq_triggerEffort{color:var(--dsw-alias-label-caption);flex:none}.sv0ekq_chevron{color:var(--dsw-alias-label-caption);flex:none;transition:transform .12s}.sv0ekq_chevronOpen{transform:rotate(180deg)}.sv0ekq_menu{z-index:20;border:1px solid var(--dsw-alias-border-inverted);background:var(--dsw-specific-menu);width:min(240px,100vw - 32px);max-height:min(360px,100vh - 96px);box-shadow:var(--dsw-shadow-lv3);color:var(--dsw-alias-label-primary);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border-radius:12px;flex-direction:column;padding:4px;display:flex;position:absolute;bottom:calc(100% + 8px);right:0;overflow:hidden}.sv0ekq_status,.sv0ekq_empty{color:var(--dsw-alias-label-tertiary);padding:10px;font-size:13px;line-height:20px}.sv0ekq_error,.sv0ekq_warning{background:var(--dsw-alias-interactive-bg-hover-danger);color:var(--dsw-alias-state-error-primary);border-radius:8px;justify-content:space-between;align-items:flex-start;gap:8px;margin-bottom:4px;padding:7px 8px;font-size:12px;line-height:18px;display:flex}.sv0ekq_warning{background:var(--dsw-alias-bg-module-platform);color:var(--dsw-alias-state-warn-label)}.sv0ekq_retry{color:inherit;font:inherit;cursor:pointer;background:0 0;border:none;flex:none;padding:0;font-weight:600}.sv0ekq_groups{min-height:0;overflow-y:auto}.sv0ekq_group+.sv0ekq_group{margin-top:4px}.sv0ekq_groupTitle{z-index:1;background:var(--dsw-specific-menu);color:var(--dsw-alias-label-tertiary);padding:5px 8px 3px;font-size:12px;font-weight:500;line-height:18px;position:sticky;top:0}.sv0ekq_fast{border-top:1px solid var(--dsw-alias-border-l3);border-radius:10px;margin-top:4px}.sv0ekq_option{width:100%;min-height:38px;color:inherit;text-align:left;cursor:pointer;background:0 0;border:none;border-radius:10px;outline:none;align-items:center;gap:8px;padding:6px 8px;display:flex}.sv0ekq_option:hover:not(:disabled),.sv0ekq_option:focus-visible{background:var(--dsw-alias-interactive-bg-hover)}.sv0ekq_selected{background:0 0}.sv0ekq_option:disabled{color:var(--dsw-alias-label-dimmed);cursor:default}.sv0ekq_optionCopy{flex-direction:column;flex:1;min-width:0;display:flex}.sv0ekq_modelName{color:inherit;text-overflow:ellipsis;white-space:nowrap;font-size:14px;font-weight:500;line-height:20px;overflow:hidden}.sv0ekq_description{color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;font-size:12px;line-height:18px;overflow:hidden}.sv0ekq_check{color:var(--dsw-alias-label-primary);flex:0 0 18px;place-items:center;display:grid}.sv0ekq_cell{width:100%;height:40px;color:var(--dsw-alias-label-primary);cursor:pointer;text-align:left;background:0 0;border:none;border-radius:10px;align-items:center;gap:8px;padding:0 10px;font-size:14px;line-height:22px;display:flex}.sv0ekq_cell:hover{background:var(--dsw-alias-interactive-bg-hover)}.sv0ekq_cellLabel{text-overflow:ellipsis;white-space:nowrap;flex:auto;min-width:0;overflow:hidden}.sv0ekq_cellValue{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-tertiary);flex:0 auto;overflow:hidden}.sv0ekq_cellChevron{color:var(--dsw-alias-label-tertiary);flex:none}";
		const tagId = "@deepseek-ai/dsh-codex-model-policy/ModelSelect.module.css";
		if (typeof document !== "undefined" && document.querySelector("style[data-plugin-css=" + JSON.stringify(tagId) + "]") === null) {
			const tag = document.createElement("style");
			tag.dataset.plugin = "@deepseek-ai/dsh-codex-model-policy";
		...
		var ModelSelect_module_css_default = {
			"cell": "sv0ekq_cell",
			"cellChevron": "sv0ekq_cellChevron",
			"cellLabel": "sv0ekq_cellLabel",
			"cellValue": "sv0ekq_cellValue",
			"check": "sv0ekq_check",
			"chevron": "sv0ekq_chevron",
			"chevronOpen": "sv0ekq_chevronOpen",
			"description": "sv0ekq_description",
			"empty": "sv0ekq_empty",
			"error": "sv0ekq_error",
			"fast": "sv0ekq_fast",
			"group": "sv0ekq_group",
			"groupTitle": "sv0ekq_groupTitle",
			"groups": "sv0ekq_groups",
			"menu": "sv0ekq_menu",
			"modelName": "sv0ekq_modelName",
			"option": "sv0ekq_option",
			"optionCopy": "sv0ekq_optionCopy",
			"retry": "sv0ekq_retry",
			"root": "sv0ekq_root",
			"selected": "sv0ekq_selected",
			"status": "sv0ekq_status",
			"trigger": "sv0ekq_trigger",
			"triggerEffort": "sv0ekq_triggerEffort",
			"triggerLabel": "sv0ekq_triggerLabel",
		...
		*/
		function ModelSelect({ locked, available, directory, load, select, toggleFast, t }) {
			...
			const chooseFast = () => {
				...
				lastActionRef.current = "select";
				toggleFast(!state.fast.active).then(settleSelection);
			};
		...
		*/
		function apply(ctx) {
			ctx.effect(() => ctx.locale.register(NS, {
				zh,
				en
			}), "codex-model-policy: dictionaries");
				...
				scope.slots.inject("conversation.input.model", () => scope.slots.register({
					...
					inject: (sessionId) => {
						...
						return {
							...
							toggleFast: (active) => available ? directory.setFast(active).then(() => true, () => false) : Promise.resolve(false)
						};
					}
				}, ModelSelect));
			});
