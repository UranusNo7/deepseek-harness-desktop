...
export declare const PI_AI_SERVICE_TIERS: readonly ["auto", "default", "flex", "scale", "priority", "fast"];
...
export declare const ProviderProfileConfig: z<PiAiProviderProfile>;
